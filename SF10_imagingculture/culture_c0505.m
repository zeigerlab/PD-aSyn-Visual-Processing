...
% z-score
all_preF = cat(2, c0505_iv.pre_F);
all_postF = cat(2, c0505_iv.post_F);
...
for ii = 1:size (all_preF,2)
    [amp_pre, idx_pre] = findpeaks (all_preF (:,ii),  'MinPeakHeight',7); 
    [amp_post, idx_post] = findpeaks (all_postF (:,ii),  'MinPeakHeight',7);   
